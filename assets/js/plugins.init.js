...
try {
    if(document.getElementById("days")){
        ...
        var eventCountDown = new Date("Aug 2, 2025 10:30:00").getTime();
        ...
        var myfunc = setInterval(function () {
            ...
            document.getElementById("days").innerHTML = days + "<p class='count-head'>Hari</p> "
            document.getElementById("hours").innerHTML = hours + "<p class='count-head'>Jam</p> "
            document.getElementById("mins").innerHTML = minutes + "<p class='count-head'>Menit</p> "
            document.getElementById("secs").innerHTML = seconds + "<p class='count-head'>Detik</p> "
